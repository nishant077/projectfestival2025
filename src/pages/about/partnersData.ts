...
export const partners =[
    ...
    },
    {
        image: partner4,
        title:'Peace Direct',
        description:'Peace Direct is an international NGO which supports local people in some of the most challenging conflict environments worldwide. We support local people to stop violence by providing them with the support, skills, resources and voice needed to make peace a practical option.',
    },
